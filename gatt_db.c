...
{
0x5c, 0xd1, 0xfe, 0x43, 0x0e, 0x3f, 0x3d, 0xa8, 0x69, 0x4a, 0xbb, 0x1e, 0xc0, 0x36, 0x07, 0x91, 
0xfa, 0x20, 0x05, 0xd7, 0x30, 0x14, 0xc5, 0xae, 0x30, 0x4e, 0xf8, 0x31, 0x1e, 0x7d, 0xd1, 0xf5, 
0xf8, 0x04, 0x2f, 0xe6, 0x49, 0xea, 0xb1, 0xa1, 0x94, 0x40, 0x5c, 0xb1, 0x7e, 0xdc, 0xa7, 0x1b, 
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_44 ) = {
	.len=19,
	.data={0x08,0x2e,0x00,0x63,0x60,0x32,0xe0,0x37,0x5e,0xa4,0x88,0x53,0x4e,0x6d,0xfb,0x64,0x35,0xbf,0xf7,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_35 ) = {
	.len=9,
	.data={0x42,0x75,0x6c,0x6b,0x41,0x6c,0x73,0x55,0x76,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_33 ) = {
	.len=19,
	.data={0x02,0x23,0x00,0x9c,0x43,0xf3,0xd2,0x62,0xa9,0x24,0xaa,0x76,0x40,0x42,0x6d,0xe6,0xa9,0x44,0x2f,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_30 ) = {
	.len=19,
	.data={0x02,0x20,0x00,0x92,0x4c,0x6f,0x12,0xfe,0x87,0x13,0x98,0xbf,0x4c,0xfe,0x60,0xd8,0xff,0x69,0x4d,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_27 ) = {
	.len=19,
	.data={0x02,0x1d,0x00,0xb0,0x82,0x5a,0xbb,0x55,0x0b,0x82,0xb0,0xc6,0x4e,0x54,0xb1,0x6d,0x4c,0xaa,0xac,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_26 ) = {
	.len=7,
	.data={0x4d,0x61,0x78,0x54,0x69,0x6d,0x65,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_24 ) = {
	.len=19,
	.data={0x0a,0x1a,0x00,0x34,0xf7,0x44,0x1b,0x2a,0xc0,0x27,0x8d,0x55,0x48,0xd6,0xfd,0xce,0x7a,0x1e,0x3b,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_19 ) = {
	.len=6,
	.data={0x4d,0x69,0x6e,0x75,0x74,0x65,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_17 ) = {
	.len=19,
	.data={0x0a,0x13,0x00,0xf8,0x04,0x2f,0xe6,0x49,0xea,0xb1,0xa1,0x94,0x40,0x5c,0xb1,0x7e,0xdc,0xa7,0x1b,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_16 ) = {
	.len=4,
	.data={0x48,0x6f,0x75,0x72,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_14 ) = {
	.len=19,
	.data={0x0a,0x10,0x00,0xfa,0x20,0x05,0xd7,0x30,0x14,0xc5,0xae,0x30,0x4e,0xf8,0x31,0x1e,0x7d,0xd1,0xf5,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_13 ) = {
	.len=16,
	.data={0x5c,0xd1,0xfe,0x43,0x0e,0x3f,0x3d,0xa8,0x69,0x4a,0xbb,0x1e,0xc0,0x36,0x07,0x91,}
};
...
uint8_t bg_gattdb_data_attribute_field_10_data[13]={0x4c,0x69,0x67,0x68,0x74,0x20,0x53,0x65,0x6e,0x73,0x6f,0x72,0x00,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8001,.permissions=0x803,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_15},
    {.uuid=0x0006,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_16},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_17},
    {.uuid=0x8002,.permissions=0x803,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_18},
    {.uuid=0x0006,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_19},
    ...
    {.uuid=0x8004,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_22},
    {.uuid=0x0006,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_23},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_24},
    {.uuid=0x8005,.permissions=0x803,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_25},
    {.uuid=0x0006,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_26},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_27},
    {.uuid=0x8006,.permissions=0x801,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_28},
    {.uuid=0x0006,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_29},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_30},
    {.uuid=0x8007,.permissions=0x801,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_31},
    {.uuid=0x0006,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_32},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_33},
    {.uuid=0x8008,.permissions=0x801,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_34},
    ...
    {.uuid=0x0008,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_38},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_39},
    {.uuid=0x0009,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_40},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_41},
    {.uuid=0x000a,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_42},
    ...
    {.uuid=0x800a,.permissions=0x802,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_45},
};
...
GATT_DATA(const uint8_t bg_gattdb_data_adv_uuid128_map[])={0x5c, 0xd1, 0xfe, 0x43, 0x0e, 0x3f, 0x3d, 0xa8, 0x69, 0x4a, 0xbb, 0x1e, 0xc0, 0x36, 0x07, 0x91, 0xca, 0x4f, 0xb3, 0x43, 0x94, 0xd2, 0x78, 0x94, 0x91, 0x47, 0x62, 0xb1, 0xd1, 0x49, 0xd3, 0x33, };
